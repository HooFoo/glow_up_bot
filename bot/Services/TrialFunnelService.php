...
class TrialFunnelService
{
    ...
    private function sendDay1(array $user): void
    {
        ...
        $keyboard = TelegramApi::inlineKeyboard([
            [['text' => $this->textService->get('btn_trial_send_photo', '📸 Отправить фото', true), 'callback_data' => 'mode_nutrition']],
        ]);
    ...
    private function sendDay2(array $user): void
    {
        ...
        $keyboard = TelegramApi::inlineKeyboard([
            [['text' => $this->textService->get('btn_trial_check_cosmetics', '🧴 Разобрать средство', true), 'callback_data' => 'mode_cosmetics']],
        ]);
    ...
    private function sendDay3(array $user): void
    {
        ...
        $keyboard = TelegramApi::inlineKeyboard([
            [['text' => $this->textService->get('btn_trial_build_day', '🥗 Собрать мой день', true), 'callback_data' => 'mode_beauty_assistant']],
        ]);
    ...
    private function sendDay4(array $user): void
    {
        ...
        $keyboard = TelegramApi::inlineKeyboard([
            [['text' => $this->textService->get('btn_trial_full_version', '💎 Хочу полную версию', true), 'callback_data' => 'buy_subscription']],
        ]);
